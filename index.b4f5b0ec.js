...
})({"2oi8z":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "29c94174b4f5b0ec";
"use strict";
...
},{}],"eMsu0":[function(require,module,exports) {
...
accordionTriggers.forEach((trigger)=>{
    trigger.addEventListener("click", (e)=>{
        ...
        if (e.target.parentNode.parentNode.classList.contains("is-active-ac")) {
            slideUp(panel, speedAnimation);
            panel.addEventListener("transitionrun", ()=>{
                trigger.parentNode.parentNode.classList.remove("is-active-ac");
            }, {
                once: true
            });
        } else {
            accordionPanels.forEach(function(item) {
                if (item.classList.contains("is-active-ac")) {
                    ...
                    item.querySelector(".accordion__content").addEventListener("transitionrun", ()=>{
                        item.classList.remove("is-active-ac");
                    }, {
                        once: true
                    });
                }
            });
            trigger.parentNode.parentNode.classList.add("is-active-ac");
            slideDown(panel, speedAnimation);
        }
    });
});
/* Side Animation */ let slideUp = (target, duration = 500)=>{
...
},{}]},["2oi8z","eMsu0"], "eMsu0", "parcelRequire9af9")

//# sourceMappingURL=index.b4f5b0ec.js.map
